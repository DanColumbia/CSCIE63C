...
plot(sample.sizes,mean.sds, main="SEM vs sample size",pch=19,ylab = 'SEM', xlab = 'Sample size')
...
for(N in N.vector){
  ...
  hist(s.values,breaks=10,col='lightgreen',main=paste("N =",N))
}
par(old.par)
...
#Answer:
##It approaches a normal distribution. Its average approches a constant which is the mean of the distribution drawn from, SD approaches original distribution divided by sqrt(N). In the limit of large $N$, it will be a normal distribution. 
